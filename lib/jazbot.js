...
var sessiondata = {owner:argv.owner}; // global variables for the current irc session stored in here
if (argv.authpass) config.authpass = argv.authpass; // override config.authpass with cli authpass arg
